...
async fn fetch_pkg_info(data: AppData, pkg: &str, max: usize) -> anyhow::Result<Sendable> {
...
async fn fetch_pkg_list(data: AppData, pkg: &str, max: usize) -> anyhow::Result<Sendable> {
